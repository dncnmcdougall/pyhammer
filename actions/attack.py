...
@action("attack")
def attack(A: int, options: AttackOptions) -> list[Outcome]:
    if isinstance(A, Dice):
        return [Outcome(o.roll_value, o.roll_value, o.success, o.bypass_next, o.reroll) for o in A()]
    else:
